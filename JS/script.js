...
$(function(){
    ...
    function getPokemonInfo(nameOrID) {
        //Connect to the web server & get a reponse 
        //Do this with the response

        //Wee need a way to asychoronously handle making the API call and doing stuff when we get a response since we don't know how long it will take to get a response.

        //If we tried to write synchoronous code (code that runs one line after another) this could cause promblems if we try to pull information from the API repsonse before we get it back.
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                //Get the pokemons weight
                let weight = result.weight;

                //Get the types that pokemon has 
